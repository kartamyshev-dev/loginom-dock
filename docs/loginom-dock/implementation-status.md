...
Native-плагины Codex/Hermes, архив с очисткой и надёжной доставкой, установка,
версионированные пакеты и полная live-приёмка двух агентов ещё не завершены.
Для эксплуатации остаётся автоматическая внешняя копия и итоговая проверка
всех релизных артефактов. Полная приёмка Hermes и публичная публикация ещё не
завершены. GitHub CLI отклонил сохранённый токен (401); запрошен повторный вход.
Весь первый выпуск пока не готов.
