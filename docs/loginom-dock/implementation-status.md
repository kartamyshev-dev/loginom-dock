...
зафиксированы в памятке и руководстве выпуска; исправление кода остаётся отдельной
работой перед следующим выпуском. Проверены 56 локальных Markdown-ссылок, синтаксис
...
Перед следующим клиентским выпуском также требуется устранить описанную выше
зависимость теста лендинга от файлов вне клиентского комплекта.
