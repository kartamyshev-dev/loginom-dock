...
Текущий результат: клиент `0.1.0-rc.1` опубликован, Studio обновлена, полные сценарии
Codex и Hermes проверены. Отложенные пользователем проверки перечислены в конце.
...
серверная сборка и публикация клиента, обновление Studio и проверка подключения.
