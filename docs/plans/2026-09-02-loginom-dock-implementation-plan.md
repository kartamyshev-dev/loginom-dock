...
- [ ] Из общего архива извлекать знания о Loginom с источниками. Не создавать
...
| Чистая установка | На macOS/Linux клиент проходит установку без локальных e2e/help, Context7 и заранее подготовленного browser MCP |
